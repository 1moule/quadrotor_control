...
namespace quadrotor_localization
{
Scan2MapLocation::Scan2MapLocation() : private_node_("~"), tf_listener_(tfBuffer_)
{
  ...
  location_info_publisher_ =
    node_handle_.advertise<quadrotor_msgs::LocationInfo>("location_info", 1, this);
...
bool Scan2MapLocation::RelocalizeCallback(
  quadrotor_msgs::Relocate::Request & req, quadrotor_msgs::Relocate::Response & res)
{
  ros::Rate rate(10);
  ...
  Eigen::Isometry3d & trans, PointCloudT::Ptr & cloud_scan_msg, PointCloudT::Ptr & cloud_map_msg)
{
  ...
  quadrotor_msgs::LocationInfo location_info_msg;
